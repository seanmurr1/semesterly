...
def sis_post(self):
    setUpMockData(self)
    # These tokens were generated by our custom script.
    # https://jsfiddle.net/JJamesWWang/pne1w52L/7/
...
class StudentSISViewTest(APITestCase):
    ...
    def test_new_advisor_appends(self):
        response = sis_post(self)
        self.assertEquals(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_new_post_updates(self):
        ...
        # https://jsfiddle.net/JJamesWWang/b0mrxga9/10/
    ...
    def test_invalid_token_fails(self):
        setUpMockData(self)
        # Removed first character of a token
